...
public class NorthPanel extends JPanel {
    ...
    public NorthPanel() {
        ...
        gbcWEST.gridx = 0;
        gbcWEST.gridy = 0;
        gbcWEST.insets = new Insets(0, 25, 10, 0);
        ...
        gbcWEST.gridy = 1;
        gbcWEST.insets = new Insets(10, 15, 20, 0);
        ...
        JLabel title = new JLabel(" PokeINV", SwingConstants.CENTER);
        ...
        subtitle.setFont(new Font("calibri", 1, 20));
